...
import { ClubCricketPage } from "../club-cricket-page";
import { ContactPage } from "../contact-page";
import { LiveMatchWidget } from "../live-match-widget";
        ...
        <div className="max-w-7xl mx-auto px-6 py-6 flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-4 flex-wrap justify-center sm:justify-start">
            ...
            <img
              ...
              className="h-5 w-auto opacity-50 hover:opacity-90 transition-opacity object-contain"
